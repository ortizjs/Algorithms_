//AE's solution which is recursive approach with O(log n ) time abd O(n) space
...
// My solution would be O(n) where n is the total number of nodes in the tree and the space would be O(n) as well. 
